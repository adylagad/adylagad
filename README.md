...
Building at the intersection of **AI, data, and scalable systems** — from ML pipelines and backend architectures to AI-driven automation workflows.

Previously **Software Engineer @ Bajaj Finserv Health** · **Intern @ CuriousJr**
...
| Role | Company | Period |
|------|---------|--------|
| **Software Engineer** | Bajaj Finserv Health | _update_ |
| **Software Engineer Intern** | Bajaj Finserv Health | _update_ |
| **Software Engineer Intern** | CuriousJr | _update_ |
...
|--------|-----------|------|
| **M.S. Computer Science** | University of Southern California (Viterbi) | _update_ |
| **B.E. Computer Science** | PICT, Pune | _update_ |
...
- AI-driven automation workflows with n8n and OpenAI
